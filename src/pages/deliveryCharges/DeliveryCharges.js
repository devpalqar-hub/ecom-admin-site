...
export default function DeliveryCharges() {
    ...
    /* ================= UI ================= */
    return (_jsxs("div", { className: styles.page, children: [_jsxs("div", { className: styles.header, children: [_jsxs("div", { children: [_jsx("h1", { children: "Delivery Charges" }), _jsx("p", { children: "Manage delivery charges by postal code" })] }), _jsxs("button", { className: styles.addBtn, onClick: () => setShowCreate(true), children: [_jsx(FiPlus, {}), " Add Charges"] })] }), _jsx("div", { className: styles.filters, children: _jsxs("div", { className: styles.searchBox, children: [_jsx(FiSearch, { className: styles.searchIcon }), _jsx("input", { placeholder: "Search postal code...", value: search, onChange: (e) => {
                                setPage(1);
